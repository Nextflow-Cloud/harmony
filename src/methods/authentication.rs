...
use crate::methods::{IdentifyMethod, IdentifyResponse, Response, NotFoundResponse};
...
pub fn identify(
    ...
    let token_message = decode::<User>(&method.token, &DecodingKey::from_secret(JWT_SECRET.as_ref()), &Validation::new(Algorithm::HS256));
    match token_message {
        Ok(r) => {
